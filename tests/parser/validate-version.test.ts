...
describe('validateOpenAPIVersion', () => {
  ...
  it('should accept OpenAPI 3.1.0', () => {
    const spec = { openapi: '3.1.0' };
    expect(validateOpenAPIVersion(spec)).toBe('3.1.0');
  });

  it('should accept OpenAPI 3.1.1', () => {
    const spec = { openapi: '3.1.1' };
    expect(validateOpenAPIVersion(spec)).toBe('3.1.1');
  });
